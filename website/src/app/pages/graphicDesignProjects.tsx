    ...
    >
      ...
      <div className="p-2 pt-1 overflow-auto h-full">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2">
          ...
          <ProjectCard title={"J.I.D Poster"} description={"A poster I made of the rapper JID in a collage style"} date={"Jul 2025"} gh={""} category={"Poster"} link={""} pic={"/gd/JID.png"}/>
          <ProjectCard title={"MF DOOM Poster"} description={"A poster I made of the rapper MF DOOM in a brutalist style"} date={"Jul 2025"} gh={""} category={"Poster"} link={""} pic={"/gd/MFDOM.jpg"}/>
