    ...
    >
      ...
      <div className="p-2 pt-1 overflow-auto h-full">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2">
          ...
          <ProjectCard title={"Bad Game Design"} description={"A game built for the GMTK GameJam 2023. My first complete game built on Unity, it was based on the theme \"Role Reversal\" and the player takes on the role of the level, trying to kill the runner. Code by Tejas Panja."} date={"Jul 2023"} category={"Games"} gh={""} link={"https://cyanixe.itch.io/bad-game-design"} pic={"/code/badgamedesignpic.jpg"}/>
        </div>
      </div>
    </div>
  );
